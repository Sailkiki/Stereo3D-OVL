- # Language-Driven Real-Time 3D Perception from Stereo Vision
  ...
  An end-to-end real-time stereo depth perception system built on Fast-FoundationStereo (CVPR 2026). Full pipeline from camera calibration to TensorRT inference to language-driven 3D object localization.

  **Office Scene Demo**:

  ![Office Demo](assets/office_demo.gif)

  *[Full video (MP4)](assets/office_demo.mp4)*

  **KITTI Driving Scene Demo**:

  ![KITTI Demo](assets/kitti_demo.gif)

  *[Full video (MP4)](assets/kitti_demo.mp4)*
  ...
  | Metric | Value |
  |--------|-------|
  | Calibration RMS | L:0.26px / R:0.28px / Stereo:1.20px |
  | TRT Inference (320×736) | 19ms |
  | End-to-End FPS | 18-25 |
  | KITTI δ<1.25 (zero-shot) | 97.2% |
  | KITTI RMSE | 2.98m |
